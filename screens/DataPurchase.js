import { StyleSheet, Text, View, TextInput, FlatList, Pressable, Image, TouchableOpacity, ScrollView } from 'react-native'
...
const DataPurchase = () => {
  ...
  const { Mobile, setMobile, NetworkProvider, setNetworkProvider,  Amount, setAmount,  DataPlan, setDataPlan } = useAccountType();
    ...
    <View>
      ...
      <ScrollView>
        ...
        <View style={styles.picker}>
          <Text style={styles.servicePlansText}>Service Plans</Text>
          ...
          <Picker
            ...
            style={styles.selected_account}
            >
            <Picker.Item label="Select Data Plan" value="" />
            <Picker.Item label="MTN 1GB" value="1GB"/>
            <Picker.Item label="GLO 2GB" value="2GB" />
          </Picker>
...
const styles = StyleSheet.create({
    ...
    Continue: {
      ...
      marginHorizontal: windowWidth * 0.05,
      marginBottom: windowHeight * 0.45,
      borderRadius: 20,
      alignSelf: 'center',
